    ...
    <View style={st.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={st.qrWrap}>
          ...
          <View style={st.qrBox}>
            {wallet?.address ? (<QRCode value={addr} size={200} backgroundColor="#fff" color="#070705" />) : (<View style={{width:200,height:200,alignItems:"center",justifyContent:"center"}}><Text style={{color:C.dim}}>No wallet</Text></View>)}
          </View>
        </View>
        ...
        <View style={st.warn}>
          ...
          <Text style={st.warnTx}>Only send ERC-20 compatible tokens.</Text>
        </View>
      </ScrollView>
    </View>
  );
...
const st = StyleSheet.create({
  ...
  psub:{ fontSize:11,color:C.dim,marginTop:3},
  ...
  qrLbl:{ fontSize:11,fontWeight:"700",color:C.m2,letterSpacing:0.8,marginBottom:16},
  qrBox:{ padding:18,backgroundColor:"#fff",borderRadius:20,elevation:8},
  ...
  addrVal:{ fontSize:11,fontFamily:"monospace",color:C.dim,lineHeight:18,marginBottom:14},
