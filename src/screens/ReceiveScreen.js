...
function QRCode() {
  const modules = [
    [20,20],[32,20],[44,20],[56,20],[68,20],
    [20,32],[68,32],
    [20,44],[44,44],[68,44],
    [20,56],[44,56],[68,56],
    [20,68],[32,68],[44,68],[56,68],[68,68],
    [92,20],[116,20],[140,20],
    [92,32],[104,32],[128,32],
    [80,44],[104,44],[116,44],[140,44],
    [80,56],[92,56],[128,56],
    [80,80],[104,80],[128,80],
    [92,92],[116,92],[140,92],
    [80,104],[104,104],
    [80,116],[92,116],[116,116],[128,116],[140,116],
    [20,92],[44,92],[56,92],
    [20,104],[32,104],[56,104],
    [20,116],[44,116],
    [20,128],[32,128],[56,128],
    [20,140],[44,140],[56,140],
    [92,128],[116,128],[140,128],
    [104,140],[128,140],
  ];
  ...
  return (
    <View style={styles.qrWrapper}>
      <Svg width="180" height="180" viewBox="0 0 180 180">
        ...
        {modules.map(([x,y],i) => (
          <Rect key={i} x={x} y={y} width="10" height="10" rx="1" fill="#0A0700" />
        ))}
        {corners.map(([x,y],i) => (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.bg }} edges={['top']}>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chipRow}>
          {TOKENS.map(tk => (
            <TokenChip key={tk.symbol} symbol={tk.symbol} color={tk.color}
              selected={selectedToken === tk.symbol} onPress={() => setSelectedToken(tk.symbol)} />
          ))}
        </ScrollView>
        ...
        <Card style={styles.addrCard}>
          ...
          <TouchableOpacity
            ...
            style={[styles.copyBtn, {
              ...
              borderColor: copied ? theme.gold : theme.border,
            }]}
          >
            <Text style={[styles.copyBtnText, { color: copied ? theme.gold : theme.muted }]}>
        ...
        <View style={[styles.warning, { backgroundColor: 'rgba(201,168,76,0.04)', borderColor: 'rgba(201,168,76,0.12)' }]}>
          ...
          <Text style={[styles.warnText, { color: theme.muted }]}>
            Only send ERC-20 compatible tokens to this address.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  qrWrapper: {
    ...
    shadowColor: '#C9A84C', shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.2, shadowRadius: 20, elevation: 8,
  },
  ...
  warnText: { flex: 1, fontSize: 10, lineHeight: 16 },
});
