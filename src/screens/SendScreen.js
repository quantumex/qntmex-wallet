        ...
        <View style={styles.confirmContainer}>
          ...
          <Card style={styles.confirmCard}>
            {[
              ...
              ['Gas Fee', '~$4.20'],
              ['Total', `${amount} ${selectedToken} + gas`],
            ].map(([k, v], i, arr) => (
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.amtCard}>
          <View style={styles.amtHeader}>
            ...
            <TouchableOpacity onPress={() => setAmount(token?.bal.replace(',', '') || '')}
              style={styles.maxBtn}>
          ...
          <TextInput
            ...
            style={[styles.amtInput, { color: theme.text }]}
          />
        ...
        <Card style={[styles.addrCard]}>
          ...
          <TextInput
            ...
            placeholderTextColor={theme.muted}
            style={[styles.addrInput, { color: theme.text }]}
          />
        </Card>
        ...
        {RECENT_ADDRESSES.map(addr => (
          <TouchableOpacity key={addr} onPress={() => setAddress(addr)}
            style={[styles.recentBtn, { backgroundColor: theme.card, borderColor: theme.border }]}>
...
const styles = StyleSheet.create({
  ...
  confirmKey: { fontSize: 11 },
  confirmVal: { fontSize: 11, fontFamily: 'monospace' },
});
