    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.bg }} edges={['top']}>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Card>
            <SettingsRow icon="◑" label="Dark Mode" sub="Toggle dark / light theme" right={<Toggle value={isDark} onToggle={toggleTheme} />} noBorder />
          </Card>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Card>
            <SettingsRow icon="⬡" label="Biometric Auth" sub="Face ID / Fingerprint" right={<Toggle value={biometric} onToggle={() => setBiometric(v => !v)} />} />
            <SettingsRow icon="⬡" label="Change PIN" sub="Update your 6-digit PIN" right={<Text style={{ color: theme.muted, fontSize: 18 }}>›</Text>} />
            <SettingsRow icon="⬡" label="Recovery Phrase" sub="View 12-word backup" right={<Text style={{ color: theme.muted, fontSize: 18 }}>›</Text>} noBorder />
          </Card>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Card>
            <SettingsRow icon="◈" label="Currency" right={<Text style={[styles.prefVal, { color: theme.gold }]}>USD ›</Text>} />
            <SettingsRow icon="◈" label="Network" right={<Text style={[styles.prefVal, { color: theme.gold }]}>Mainnet ›</Text>} />
            <SettingsRow icon="◈" label="Hide Small Balances" right={<Toggle value={hideSmall} onToggle={() => setHideSmall(v => !v)} />} noBorder />
          </Card>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Card>
            <SettingsRow icon="◇" label="Transaction Alerts" sub="Notify on sends & receives" right={<Toggle value={notifications} onToggle={() => setNotifications(v => !v)} />} noBorder />
          </Card>
        </View>
